...
class Module:
    def __init__(self, config):
        self.exclude = config.get("exclude_list")
        self.ra_l = config.getfloat("ra_l",-2)
        self.ra_h = config.getfloat("ra_h",2)
        self.dec_l = config.getfloat("dec_l",-0.4)
        self.dec_h = config.getfloat("dec_h",0.4)
        self.ra_bins = config.getint("ra_bins",100)
        self.dec_bins = config.getint("dec_bins",100)
