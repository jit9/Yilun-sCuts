...
class Module:
    def __init__(self, config):
        self.ctime_start = config.getint('ctime_start', 0)
        self.loading_max = config.getfloat('loading_max', 10)
        self.live_min = config.getint('live_min', 300)
...
def get_beam_solid_angle(array,season):
    bso = {'s13': {'PA1':195.3},
           ...
           's19': {'PA4_150':218.2, 'PA4_220':116.8, 'PA5_90':428.1, 'PA5_150':201.1, 'PA6_90':463.7, 'PA6_150':215.5}
       }
