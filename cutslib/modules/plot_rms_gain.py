...
class Module:
    def __init__(self, config):
        self.xbins = config.getint("xbins", 100)
        self.ybins = config.getint("ybins", 100)
        self.xmin = config.getfloat("xmin", 0)
        self.xmax = config.getfloat("xmax", 1e-15)
        self.ymin = config.getfloat("ymin", 0)
        self.ymax = config.getfloat("ymax", 4e-16)
